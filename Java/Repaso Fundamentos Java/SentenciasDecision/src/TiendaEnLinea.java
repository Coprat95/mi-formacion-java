...
public class TiendaEnLinea {
    public static void main(String[] args) {
        ...
        System.out.println("Introduzca el importa de la compra: ");
        var importe = Integer.parseInt(scanner.nextLine());
        System.out.println("Es usted cliente de la tienda (true/false) ? ");
        var esCliente = Boolean.parseBoolean(scanner.nextLine());
        var descuento10 = 0.10;
        var descuento5 = 0.05;
        if (importe >= 1000 && esCliente ) {
            var importe10 = importe - (importe*descuento10);
            System.out.println("Se le aplicará un descuento del 10%");
            System.out.println("El valor total es de "+ importe10+" €.");
        } else if (importe <1000 && esCliente) {
            var importe5 = importe - (importe*descuento5);
            System.out.println("Se le aplicará un descuento del 5%");
            System.out.println("El valor total es de "+ importe5+" €.");

        } else {
            System.out.println("Lo sentimos, no se le aplicará ningún descuento.");
        }
